...
<link href="./PES University_files/bootstrap.css" rel="stylesheet">
<link href="./PES University_files/font-awesome.css" rel="stylesheet">
<link href="./PES University_files/pesu-ico.css" rel="stylesheet">
<link href="./PES University_files/style.css" rel="stylesheet">
<link href="./PES University_files/academy_login.css" rel="stylesheet">
</head>
...
<div class="login-header">
        <div class="col-md-12 col-sm-12">
                <img src="./PES University_files/logoPesu.png" alt="PES University">
        </div>
    </div>
...
<!--                                                 <input name="bmode" type="hidden" id="bmode"> -->
	...
	<script src="./PES University_files/jquery.v1.12.4.js.download"></script>
	
	<script src="./PES University_files/bootstrap.min.js.download"></script>
	<script src="./PES University_files/bootstrapValidator.js.download"></script>
